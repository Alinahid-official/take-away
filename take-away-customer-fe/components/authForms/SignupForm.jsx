...
const handleButtonClick = () => {
  ...
  const handleModalClose = () => setModalOpen(false); 
    ...
    console.log(values.name)
       ...
       try {
        const response = await axios.post("http://localhost:4000/auth/customer/signUp",
    ...
    //   console.log(data.email)
        ...
        try {
            setLoading(true)
            setOpen(true)
            const response = await axios.post("http://localhost:4000/auth/customer/verifyOtp",
    ...
    return (
      <div className={classes.grid}>
            ...
            <input onChange={(e)=>{setEmailOtp(e.target.value)}} type="text" placeholder="Enter Otp" />
       ...
       <div className={classes['form-control']}>
        ...
        <div className={classes['form-control']}>
            ...
            <button type="button" onClick={handleModalOpen}>Add Address</button>
       </div>
                 ...
                 <label htmlFor='city'>City</label>
                  <input 
                   ...
                   <div className={classes["modal-save"]}>
                    <button type="submit"  disabled={!formik.isValid || formik.isSubmitting } onClick={handleModalOpen} onSubmit={onSubmit}>Save</button>
                    </div>
                    </form>
        </Box>
       ...
       <div className={classes.ca}>
          <button onClick={handleButtonClick} onSubmit={onSubmit} disabled={!formik.isValid || formik.isSubmitting } className={classes.button} type="submit">Create Account</button>
          {loading && (
          <CircularProgress
            size={24}
            sx={{
          ...
          <span className={classes.span}>Already Have An Account? <button onClick={pushToLogin} className={classes.login}>Login</button>  </span>
          </div>
           </div>
