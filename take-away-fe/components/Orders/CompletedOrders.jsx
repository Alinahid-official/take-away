...
const CompletedOrders = ()=>{
    ...
    useEffect(() =>{
        ...
        const getOrders =async ()=>{
            try {
                const res = await axios.get('http://localhost:4000/order/owners/completed',{
                    headers: {
                ...
                return (
                   ...
                   <div className={classes.second}>
                    <div className={classes.flex}>
                        ...
                        <h5 className={classes.delivered}> Order Delivered <span><FontAwesomeIcon icon={faCircleCheck} /></span></h5>
                    </div>
                    </div>
